...
class PremInternalConnectors(BaseConnector):
    def __init__(self, api_key: str, prompt_template: Optional[str] = None) -> None:
    ...
    def chat_completion(
        ...
        assert model_name in ['phi-1-5', 'phi-2', 'tinyllama', 'mamba-chat'], \
            ValueError("Models other than 'phi-1-5', 'phi-2', 'tinyllama', 'mamba-chat' are not supported") 
